...
function billTokWh(user_bill, tariff, return_type) {
    ...
    if (tariff == 0) {
        //Tariffs in RM
        var tariffA1 = 0.218 + ICPT;
        var bandA1 = 200;
        var cumbandA1 = tariffA1 * bandA1;
        var tariffA2 = 0.334 + ICPT;
        var bandA2 = 100;
        var cumbandA2 = tariffA2 * bandA2 + cumbandA1;
        var tariffA3 = 0.516 + ICPT;
        var bandA3 = 300;
        var cumbandA3 = (tariffA3 * bandA3) * (1 + SERVICE_CHARGE) + cumbandA2;
        var tariffA4 = 0.546 + ICPT;
        var bandA4 = 300;
        var cumbandA4 = (tariffA4 * bandA4) * (1 + SERVICE_CHARGE) + cumbandA3;
